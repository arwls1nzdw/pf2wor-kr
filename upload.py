...
def uploadMime(service, file, fileId, mime):
    try:
        ...
        print("Error connecting to Google Drive API")


uploadJson = partial(uploadMime, mime='application/json')
uploadText = partial(uploadMime, mime='text/plain')
